...
| Редактор з кодом | Завдання та підказки | Модулі навчання |
|-----------------|---------------------|-----------------|
| ![Редактор](docs/screenshots/01-auth.png) | ![Завдання](docs/screenshots/02-main.png) | ![Модулі](docs/screenshots/04-modules.png) |
